...
public:
  ...
  void insert(DNSPacket *q, DNSPacket *r, unsigned int ttl=UINT_MAX);  //!< We copy the contents of *p into our cache. Do not needlessly call this to insert questions already in the cache as it wastes resources
